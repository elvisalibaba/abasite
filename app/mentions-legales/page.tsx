...
export default function LegalPage() {
  return (
    <>
      <PageHero eyebrow="INFORMATIONS LÉGALES" title="Mentions légales" description="Informations relatives à l’éditeur et à l’utilisation du site aba-drc.com." accent="legal" />
      <section className="section legal-page"><div className="container legal-copy">
        <h2>Éditeur du site</h2><p>Le site aba-drc.com est édité par Africa Business Agency, établie à Kinshasa, République Démocratique du Congo.</p>
        <h2>Contact</h2><p>Adresse électronique : contact@aba-drc.com. Téléphone : +243 812 130 324.</p>
